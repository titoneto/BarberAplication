...
export default ({show, setShow, barber, service}) => {
    ...
    useEffect(() => {
        if(barber.available && selectedDay > 0) {
            ...
            let availability = barber.available.filter(item => item.date === selDate);
    ...
    useEffect(()=> {
        if(barber.available){
        // dia '0' no date representa o utimo dia do mes anterior
            ...
            for(let i = 1; i < daysInMonth; i++){
                ...
                let selDate = `${year}-${month}-${day}`;
                //let selDate = year + '-' + month + '-' + day;
                // selDate montado de acordo com o elemento date do available presente no barber
                let availability = barber.available.filter(item => item.date === selDate);
                ...
                <ModalBody>
                    ...
                    <ModalItem>
                        <ServiceInfo>
                            ...
                            <ServicePrice>R$ {barber.services[service].price.toFixed(2)}</ServicePrice>
                        </ServiceInfo>
                    </ModalItem>
                    }
